...
export const Route = createFileRoute("/_authenticated/dashboard")({
  head: () =>
    pageHead({
      path: "/dashboard",
      title: "Dashboard \u2014 Hyper Cluster Generative AI Studio",
      description:
        "Your Hyper Cluster studio: one prompt box for photoreal images, cinematic video, vectors and audio.",
      noindex: true,
      keywords: [
        "Hyper Cluster dashboard",
        "AI studio workspace",
      ],
    }),
  component: Dashboard,

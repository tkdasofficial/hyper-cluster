...
export const Route = createFileRoute("/audio")({
  head: () =>
    pageHead({
      path: "/audio",
      title: "AI Voice & Music Generator \u2014 Audio Studio | Hyper Cluster",
      description:
        "Generate AI speech and music with 30 voices plus tone, pace, genre, tempo and duration controls in Hyper Cluster's Audio Studio.",
      ogTitle: "AI Voice & Music Generator \u2014 Hyper Cluster Audio Studio",
      keywords: [
        "AI voice generator",
      ...
      <div className="space-y-3.5">
        ...
        <div className="rounded-2xl border border-border bg-surface/50 p-3.5">
          <TextRow
            ...
            placeholder={
              mode === "Text to speech"
                ? "Welcome to Hyper Cluster — everything you imagine, generated in seconds."

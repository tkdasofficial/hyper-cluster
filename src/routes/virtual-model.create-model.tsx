...
export const Route = createFileRoute("/virtual-model/create-model")({
  head: () =>
    pageHead({
      ...
      title: "Create an AI Character \u2014 AI Model Builder | Celestial Intelligence Copilot",
      description:
      ...
      ogTitle: "Create an AI Character \u2014 Celestial Intelligence Copilot Model Builder",
      keywords: [
        "create AI character",

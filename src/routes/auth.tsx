...
export const Route = createFileRoute("/auth")({
  ...
  head: () =>
    pageHead({
      path: "/auth",
      title: "Sign In or Sign Up \u2014 Hyper Cluster AI Studio",
      description:
        "Continue with email or Google to access the Hyper Cluster generative AI studio for image, video, vector and audio creation.",
      ogTitle: "Sign in to Hyper Cluster",
      ogDescription:
        "Continue with email or Google to access the Hyper Cluster generative AI studio.",
      keywords: [
        "Hyper Cluster login",
        "Hyper Cluster sign up",
        "AI generator login",
